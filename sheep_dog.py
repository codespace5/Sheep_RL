...
for i in range(n):
    for j in range(n):
        for o in range(n):
            for p in range(n):
                states[(i,j,o, p)] = k
                # print("staeeeef12121212323131",states)
                k+=1
istrain = True
current_pos = [0, 0]
alpha = 0.9
...
sheep_x = n-1
sheep_y = n-1
sheep_pos = [sheep_x, sheep_y]
reward[sheep_x, sheep_y] = -1
reward[sheep_pos[0]]
...
def episode():
    global current_pos,epsilon, istrain, sheep_pos, num
    # print("current",current_pos)
    current_state = states[(current_pos[0], current_pos[1], sheep_pos[0], sheep_pos[1])]
    ...
    new_state = states[(current_pos[0],current_pos[1], sheep_pos[0], sheep_pos[1])]
